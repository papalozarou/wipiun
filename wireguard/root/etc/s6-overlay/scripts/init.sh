...
# -----------------------------------------------------------------------------
# Checks to see if `$CLIENT_DNS` is blank or set to `auto` and if true sets it to
# the host's DNS.
# -----------------------------------------------------------------------------
setClientDNS () {
...
# 2. Populate the `wg0.conf` from the above `server.conf` template – clients will 
#    be added later.
# -----------------------------------------------------------------------------
generateServerConf () {
...
#
# n.b.
# `${1}` is `${CLIENT_NAME}` passed in – bash scripts reference arguements passed
...
# -----------------------------------------------------------------------------
# Check if `CLIENT_NAME` is a number or string. If it's a number return it as `clientX`
# and if it's a string return it as `client_$[string]`.
# 
